...
const en: Dict = {
  ...
  "bookings.assignTitle": "Approve booking & assign pilot",
  "bookings.assignHint": "Select an available pilot/service provider",
  "bookings.noPilots": "No available pilots",
  "bookings.assignedOk": "Booking approved and pilot assigned",
...
const bn: Dict = {
  ...
  "bookings.assignTitle": "বুকিং অনুমোদন ও পাইলট নিয়োগ",
  "bookings.assignHint": "একজন উপলব্ধ পাইলট/সেবা প্রদানকারী নির্বাচন করুন",
  "bookings.noPilots": "কোনো উপলব্ধ পাইলট নেই",
  "bookings.assignedOk": "বুকিং অনুমোদিত ও পাইলট নিযুক্ত",
